...
def require_api_key(
    x_arbiter_key: str | None = Header(default=None, alias="X-Arbiter-Key"),
...
WEBHOOK_EVENTS = [
    ...
    "evidence.revised",
    "evidence.conflict",
    "evidence.source_outage",
    "resolution.reevaluation_requested",
    "resolution.pending",
    "resolution.held",
...
def developer_manifest() -> dict:
    ...
    return {
        ...
        "semantic_contract_intelligence": {
        ...
        "enterprise_identity": {
            "version": "0.14.0",
            "tenant_context": "principal-bound",
        ...
        "production_reliability": {
            ...
            "durable_jobs": True,
            "idempotency": True,
            "signed_webhook_envelopes": True,
            "replay_protection": True,
        },
        "model_intelligence_gateway": {
            "version": "0.16.0",
        ...
        "production_data_plane": {
            ...
            "tenant_rls": True,
            "content_addressed_evidence_objects": True,
            "backup_restore_hooks": True,
            "settlement_authority": False,
        },
        "enterprise_secrets": {
            "version": "0.18.0",
            "tenant_provider_credentials": True,
            "write_only_secret_api": True,
            "production_backend": "aws-secrets-manager+kms",
            "settlement_authority": False,
        },
        ...
        "reference_exchange": {
            ...
            "end_to_end_settlement_harness": True,
            "sandbox_matching_engine": True,
        ...
        "operations_resilience": {
            ...
            "external_observability_required": True,
        },
        "settlement_assurance": {
            "version": "0.21.0",
            "internal_adversarial_suite": True,
            "frozen_holdout_registry": True,
        ...
        "external_assurance": {
            "version": "0.24.0",
            "independent_evidence_registry": True,
            "production_settlement_certified": False,
        },
