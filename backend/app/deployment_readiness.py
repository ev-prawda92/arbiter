...
def production_requirements() -> dict[str, dict[str, Any]]:
    return {
        "managed_postgresql": {
            "required": True,
            "target": "Amazon RDS PostgreSQL Multi-AZ",
            "externally_verified": False,
        },
        "managed_object_storage": {
            "required": True,
            "target": "Amazon S3 with versioning + KMS",
            "externally_verified": False,
        },
        ...
        "central_logs_metrics": {
            "required": True,
            "target": "CloudWatch logs/metrics/alarms",
            "externally_verified": False,
        },
        "tls_ingress": {
            "required": True,
            "target": "ALB HTTPS listener with ACM certificate",
            "externally_verified": False,
        },
...
def posture() -> dict[str, Any]:
    ...
    return {
        ...
        "production_environment_detected": os.environ.get("ARBITER_ENV", "development").lower()
        in {"prod", "production"},
        "artifacts": artifacts,
