...
def main():
    ...
    for profile, expected in [
        ...
        check(
            f"{profile}: awaiting evidence stays monitoring",
            b.get("arbiter_terminal_action") == "monitor_authoritative_evidence",
            str(b),
        )
    ...
    print("ENTERPRISE GATE:", "PASS" if failed == 0 else "FAIL")
