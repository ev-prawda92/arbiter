...
ZELENSKYY = {
    "case_id": "polymarket-546814",
    "venue": "polymarket",
    "title": "Will Zelenskyy wear a suit before July?",
    "rules": (
        "This market will resolve to Yes if Volodymyr Zelenskyy is photographed or "
        "videotaped wearing a suit between May 22 and June 30, 2025. The resolution "
        "source will be a consensus of credible reporting."
    ),
    "known_outcome": "NO",
    "closed_at": "2025-06-30T12:00:00Z",
    "settled_at": "2025-07-09T00:30:39Z",
    "metadata": {"uma_dispute_count": 5},
}
CPI = {
    "case_id": "polymarket-527838",
    "venue": "polymarket",
    ...
    "known_outcome": "YES",
    "closed_at": "2025-04-10T12:00:00Z",
    "settled_at": "2025-04-10T16:27:17Z",
    "metadata": {"uma_dispute_count": 0},
}
VENEZUELA = {
    "case_id": "polymarket-502006",
    "venue": "polymarket",
    ...
    "known_outcome": "YES",
    "closed_at": "2024-08-01T12:00:00Z",
    "settled_at": "2024-08-06T18:37:36Z",
    "metadata": {"uma_dispute_count": 0},
}
STRIKE = {
    "case_id": "kalshi-KXETH",
    "venue": "kalshi",
    ...
    "settled_at": "2026-09-09T18:05:00Z",
    "metadata": {},
}
IRAN_KALSHI = {
    "case_id": "kalshi-KXUSAIRANAGREEMENT-27-26AUG",
    "venue": "kalshi",
    "title": "Will the US agree to a new Iranian nuclear deal before August?",
    "rules": (
        "Resolves Yes if the US officially agrees to a new Iranian nuclear deal. For the "
        "avoidance of doubt, a memorandum of understanding does not count as a deal."
    ),
    "known_outcome": "NO",
    "closed_at": "2026-08-01T14:00:00Z",
    "settled_at": "2026-08-01T14:00:00Z",
    "metadata": {},
}
...
def test_interpretive_is_hint_not_primary():
    row = {
        ...
        "settled_at": "2026-09-09T15:00:00Z",
        "metadata": {},
    }
